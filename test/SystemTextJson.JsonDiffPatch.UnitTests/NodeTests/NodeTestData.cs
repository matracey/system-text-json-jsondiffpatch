...
namespace SystemTextJson.JsonDiffPatch.UnitTests.NodeTests
{
    ...
    {
        public static IEnumerable<object?[]> ElementRawTextEqual => DeepEqualsTestData.RawTextEqual(Json);

        public static IEnumerable<object?[]> ElementSemanticEqual => DeepEqualsTestData.SemanticEqual(Json);
        ...
        public static IEnumerable<object?[]> ElementObjectSemanticEqual
        {
            get
            {
                ...
                yield return new object?[]
                    {Json($"\"{Convert.ToBase64String(bytes)}\""), JsonValue.Create(bytes)!, true};
                yield return new object?[]
                {
                ...
                yield return new object?[]
                    {Json("\"Shaun is a rabbit\""), JsonValue.Create("Shaun is a rabbit")!, true};
